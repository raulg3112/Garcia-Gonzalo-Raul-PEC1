...
Pel que fa a l'estudi, el seu objectiu va ser observar quines eren les conseqüències d'una mutació que es localitzava al gen FatB d'*Arabidopsis* (denominada At1g08510) en la resposta a les ferides. 

# MÈTODES

S'ha escollit emprar les dades de l'estudi anomenat *Fatb Induction Experiment (FatBIE)*, que es pot trobar al següent [enllaç](https://www.metabolomicsworkbench.org/data/DRCCMetadata.php?Mode=Study&StudyID=ST000001). A la vegada, el DOI de l'estudi és: [10.21228/M8159B](http://dx.doi.org/10.21228/M8159B).

SUMMARIZEDEXPERIMENT vs EXPRESSIONSET.

Les llibreries emprades per poder generar `SummarizedExperiment` i l'anàlisi exploratori han sigut `jsonlite`, `metabolomicsWorkbenchR`,  `SummarizedExperiment` i `ggplot2`, junt amb funcions bàsiques de R.
