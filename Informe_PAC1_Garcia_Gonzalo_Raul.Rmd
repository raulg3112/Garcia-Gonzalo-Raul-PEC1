...
A partir de l'objecte creat anteriorment, es va utilitzar `colData()` per tal d'obtenir la informació addicional de les mostres. Es va utilitzar `head( , 6)` per observar només la informació de les 6 primeres mostres, ja que no és necessari imprimir-les totes per tenir una idea de quina informació contenen.
